...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "trust.languages.title": "Four languages",
    "trust.languages.body": "English, French, Arabic, and Vietnamese — explanations adapted to each.",
  ...
  fr: {
    ...
    "trust.languages.title": "Quatre langues",
    "trust.languages.body": "Anglais, français, arabe et vietnamien — explications adaptées à chacune.",
  ...
  ar: {
    ...
    "trust.languages.title": "أربع لغات",
    "trust.languages.body": "الإنجليزية والفرنسية والعربية والفيتنامية — شروحات مهيّأة لكل منها.",
  ...
  vn: {
    ...
    "trust.languages.title": "Bốn ngôn ngữ",
    "trust.languages.body": "Anh, Pháp, Ả Rập và Việt — giải thích phù hợp với từng ngôn ngữ.",
