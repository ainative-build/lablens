...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "upload.skeleton.label": "Preparing your report",
  ...
  fr: {
    ...
    "upload.skeleton.label": "Préparation de votre rapport",
  ...
  ar: {
    ...
    "upload.skeleton.label": "جاري تجهيز تقريرك",
  ...
  vn: {
    ...
    "upload.skeleton.label": "Đang chuẩn bị báo cáo",
