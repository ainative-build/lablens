...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "upload.timing_hint": "This usually takes 30–60 seconds (OCR + interpretation).",
  ...
  fr: {
    ...
    "upload.timing_hint": "Cela prend généralement 30 à 60 secondes (OCR + interprétation).",
  ...
  ar: {
    ...
    "upload.timing_hint": "تستغرق هذه العملية عادةً من 30 إلى 60 ثانية (OCR + التفسير).",
  ...
  vn: {
    ...
    "upload.timing_hint": "Thường mất 30–60 giây (OCR + diễn giải).",
