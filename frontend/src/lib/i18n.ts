...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "trust.fast.title": "Results in under a minute",
    "trust.fast.body": "OCR + interpretation in 30–60s for most reports.",
  ...
  fr: {
    ...
    "trust.fast.title": "Résultats en moins d'une minute",
    "trust.fast.body": "OCR + interprétation en 30 à 60 s pour la plupart des rapports.",
  ...
  ar: {
    ...
    "trust.fast.title": "نتائج في أقل من دقيقة",
    "trust.fast.body": "OCR + التفسير في 30 إلى 60 ثانية لمعظم التقارير.",
  ...
  vn: {
    ...
    "trust.fast.title": "Kết quả trong dưới một phút",
    "trust.fast.body": "OCR + diễn giải trong 30–60 giây cho hầu hết báo cáo.",
