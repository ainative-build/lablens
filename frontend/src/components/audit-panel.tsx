...
export function AuditPanel({ value, language }: Props) {
  ...
  return (
    ...
    >
      {/* "Extraction confidence" intentionally omitted — surfacing "low" on
          common results made the output read as weak even when the rest of
          the pipeline (range_trust + verification) was high-confidence. */}
